from main_app.flask_testing.factory_data import ClientFactory, ParkingFactory
...
def test_add_client(client):
    ...
    data = {
        ...
        "credit_card": _client.credit_card,
        "car_number": _client.car_number,
    }
...
def test_add_parking(client):
    ...
    data = {
        ...
        "opened": _parking.opened,
        "count_places": _parking.count_places,
        "count_available_places": _parking.count_available_places,
    }
